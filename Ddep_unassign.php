                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <table class="table table-bordered border-Dark" id="table" style="border-color: #333;">
                                        ...
                                        <h4 class="card-title text-center" style="font-size: 22px;"><u>List of Unassigned Students <?php echo $dept ?> Department</u></h4>

</div>

                                            <div style="text-align: center;">
                                                <a href="Ddep_unassign_Report.php?dept=<?php echo $dept; ?>">Download PDF
                                                    File</a>
                                            </div>


                                            <?php
                                            $result = mysqli_query($conn, "SELECT * FROM studinfo WHERE `Department` = '$dept' AND `PRN` NOT IN (SELECT `PRN` FROM assign WHERE `Department` = '$dept') ORDER BY 
                                            CASE Class
                                            ...
                                            echo "<tr>";
                                            echo "<th colspan='6' style='text-align: center;font-size: 18px;'>Total Unassigned Students: $count</th>";
                                            echo "</tr>";
                                            echo "</thead>";
                                            ?>
