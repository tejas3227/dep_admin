                    ...
                    <div class="topnav">
                            <nav class="navbar navbar-light navbar-expand-lg topnav-menu">
                                ...
                                <div class="collapse navbar-collapse" id="topnav-menu-content">
                                    <ul class="navbar-nav">
                                    <li class="nav-item">
                                        <a class="nav-link dropdown-toggle arrow-none" href="Dfaculty_assign.php?dept=<?php echo $_GET['dept'];?>&AY=<?php echo $_GET['AY'];?>" id="topnav-dashboard" role="button"
...
&&(isset($_GET['tName']) && !empty($_GET['tName']))) {
    // Store the selected academic year and department values in variables
    $tid = $_GET['tid'];
    $dept = $_GET['dept'];
    $tName = $_GET['tName'];
...
<div class="card-header justify-content-center d-flex align-items-center">
  <h4 class="card-title mx-auto" style="font-size: 24px;">Assigned Students to <?php echo $tName ?></h4>
</div>
<!-- end card header -->
                            <div class="card-content table-responsive">
                            <table class="table table-bordered border-Dark" id="table" style="border-color: #333;">
<?php 
$result = mysqli_query($conn, "SELECT * FROM assign WHERE TID = '$tid'" );
