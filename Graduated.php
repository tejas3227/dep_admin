...
<body data-layout="horizontal" data-topbar="dark">
  ...
  <h4 class="card-title mx-auto" style="font-size: 22px;">Graduated Students
                                        ...
                                        <form method="post" action="">
                                            <table class="table table-bordered border-dark" id="table1">
                                                <div style="text-align: center;">
                                                    <a
                                                        href="Graduated_Report.php?dept=<?php echo $dept; ?>&year=<?php echo $year; ?>">Download
                                                        PDF File</a>
                                                </div>
                                                <?php
                                                $result = mysqli_query($conn, "SELECT * FROM graduated_studinfo WHERE Department = '$dept' AND Class = '$year' AND Graduated_Status ='Graduated' ");
                ...
                <a href='Graduated.php?PRN=" . $row['PRN'] . "&dept=" . $dept . "&AY=" . $AY . "&year=" . $year . "' class='btn1'>
