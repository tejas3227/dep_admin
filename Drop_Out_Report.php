...
if (
    ...
    $result = mysqli_query($conn, "SELECT * FROM graduated WHERE Department = '$dept' AND Class = '$year' AND Graduated_Status ='Dropped Out' ");
    ...
    $pdf->Cell(0, 10, "Dropped Out Students Report $dept", 0, 1, 'C');
    ...
    // Output the PDF
    $pdf->Output($dept . '_' . $year . '_Dropped_Out_Students_Report.pdf', 'D');
